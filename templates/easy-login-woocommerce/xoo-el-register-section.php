...
<button type="submit" class="button btn xoo-el-action-btn xoo-el-register-btn"><?php _e('register','easy-login-woocommerce'); ?></button>

<input type="hidden" name="xoo_el_redirect" value="<?php echo esc_url( $redirect ); ?>">

<?php echo do_shortcode('[xoo_el_action type="login" text="sign in" change_to="/"]') ?>
