        ...
        <?php while ( $summer_query->have_posts() ) : $summer_query->the_post(); global $product; ?>
            ...
            <div class="wow animate__animated animate__fadeInUp product__set">
                ...
                <div class="product__set-buy">
                    ...
                    <div class="modal fade cart-product-size-modal" id="product-size-modal-<?php echo get_the_ID(); ?>" tabindex="-1" role="dialog" aria-labelledby="product-size-modal-label-<?php echo get_the_ID(); ?>" aria-hidden="true">
